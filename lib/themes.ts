...
export const THEMES: Theme[] = [
  {
    ...
    accent: '#173d75',
    pdfFile: 'https://xwvtnzjrqnlhdeuecxko.supabase.co/storage/v1/object/public/pdfs/theme-1.pdf',
    icon: 'Scale',
    subThemes: [
  ...
  },
  {
    ...
    accent: '#1e4f93',
    pdfFile: 'https://xwvtnzjrqnlhdeuecxko.supabase.co/storage/v1/object/public/pdfs/theme-2.pdf',
    icon: 'Building2',
    subThemes: [
  ...
  },
  {
    ...
    accent: '#2563b2',
    pdfFile: 'https://xwvtnzjrqnlhdeuecxko.supabase.co/storage/v1/object/public/pdfs/theme-3.pdf',
    icon: 'Network',
    subThemes: [
  ...
  },
  {
    ...
    accent: '#4d80c7',
    pdfFile: 'https://xwvtnzjrqnlhdeuecxko.supabase.co/storage/v1/object/public/pdfs/theme-4.pdf',
    icon: 'HeartHandshake',
    subThemes: [
